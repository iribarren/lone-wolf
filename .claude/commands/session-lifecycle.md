---
description: Add sign-out and 401 handling to the player app (audit B4, C1)
---

Read `docs/prompts/08-session-lifecycle.md` in full and execute it exactly as written.
