---
description: Converge the untracked increment work back into tasks.md
---

Read `docs/prompts/13-converge-increment.md` in full and execute it exactly as written.
