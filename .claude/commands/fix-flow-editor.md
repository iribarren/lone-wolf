---
description: Fix the campaign-flow editor's empty stage dropdowns (audit A2/A3, critical)
---

Read `docs/prompts/03-fix-flow-editor.md` in full and execute it exactly as written.
