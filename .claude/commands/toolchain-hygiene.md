---
description: Commit the live AI tool-chain and remove the superseded one
---

Read `docs/prompts/11-toolchain-hygiene.md` in full and execute it exactly as written.
