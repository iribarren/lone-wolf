---
description: Restore browser access to the admin backoffice (audit A1, critical)
---

Read `docs/prompts/02-fix-admin-url.md` in full and execute it exactly as written.
