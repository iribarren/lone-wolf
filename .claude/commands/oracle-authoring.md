---
description: Make oracle tables authorable and restore the US3 test (audit A4, critical)
---

Read `docs/prompts/05-oracle-authoring.md` in full and execute it exactly as written.
