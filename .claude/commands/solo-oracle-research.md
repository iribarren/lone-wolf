---
description: Research solo-RPG oracle features (Mythic, Ironsworn) and licensing
---

Read `docs/prompts/21-solo-oracle-research.md` in full and execute it exactly as written.
